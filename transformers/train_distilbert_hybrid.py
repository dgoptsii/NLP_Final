...
from transformers.transformer_common import RunConfig, run_training


def main():
    parser = argparse.ArgumentParser(description="Train and save DistilBERT phishing classifier.")
